...
describe "Admin user can see all merchants" do
  before :each do
    ...
    @regular_user_address = @regular_user.addresses.create!(address_nickname: 'Home', address: "234 Main", city: "Denver", state: "CO", zip: 80204)
    ...
    @admin_address = @admin.addresses.create!(address_nickname: 'Home', address: '123 Oak Ave', city: 'Denver', state: 'CO', zip: 80021)
