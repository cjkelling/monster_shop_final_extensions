...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    before(:each) do
      ...
      @regular_user = User.create!(name: 'alec', address: '234 Main', city: 'Denver', state: 'CO', zip: 80_204, email: '10@gmail.com', password: 'password')
    ...
    it 'get_individual_orders' do
      ...
      regular_user = User.create!(name: 'alec',
                                  ...
                                  email: '5@gmail.com',
                                  password: 'password')
      @order_1 = regular_user.orders.create!(name: 'Sam Jackson', address: '223 Main St', city: 'Seattle', state: 'Washington', zip: 99_987, status: 0)
      @order_2 = regular_user.orders.create!(name: 'Sam Jackson', address: '223 Main St', city: 'Seattle', state: 'Washington', zip: 99_987, status: 0)
      ...
      actual_subtotal_for_bike_shop = @bike_shop.get_individual_orders.map(&:total_subtotal).sort
